          ...
          >
            ...
            <v-menu :key="index" offset-y :close-on-content-click="false">
              ...
              <div class="filter-container">
                ...
                <div
                  v-else
                  v-for="(data, index) in filterKeys[colName]"
                  :key="index"
                >
                  <v-checkbox
                    :label="data"
                  ...
                  >
                    ...
                    <div class="inner-container">
                      ...
                      <span v-else>
                        ...
                        <span
                          v-if="
                            config[col.value].icon(item[col.value], item)
                              .name !== ''
                          "
                        >
                          <v-icon
                        ...
                        <span
                          ...
                          "
                          >{{
                            config[col.value].text(item[col.value], item)
                          }}</span
                        >
                      </span>
                    </div>
    ...
    customFilterOnSelect(value, search, row) {
      ...
      selectedFilters.forEach((head) => {
        ...
        filterValues.forEach((value) => {
          if (
            objValue.toString().toLowerCase().indexOf(value.toLowerCase()) !==
            -1
          ) {
            isMatch = true;
          }
